...
{{--                            <span class="avatar avatar-md brround ml-3 align-self-center cover-image" data-image-src="{{url('assets/admin')}}/images/users/1.jpg"></span>--}}
{{--                            <div>--}}
...
{{--                        </a>--}}
{{--                        <a class="dropdown-item d-flex pb-3" href="#">--}}
{{--                            <span class="avatar avatar-md brround ml-3 align-self-center cover-image" data-image-src="{{url('assets/admin')}}/images/users/12.jpg"></span>--}}
{{--                            <div>--}}
...
{{--                        </a>--}}
{{--                        <a class="dropdown-item d-flex pb-3" href="#">--}}
{{--                            <span class="avatar avatar-md brround ml-3 align-self-center cover-image" data-image-src="{{url('assets/admin')}}/images/users/4.jpg"></span>--}}
{{--                            <div>--}}
...
{{--                        </a>--}}
{{--                        <a class="dropdown-item d-flex pb-3" href="#">--}}
{{--                            <span class="avatar avatar-md brround ml-3 align-self-center cover-image" data-image-src="{{url('assets/admin')}}/images/users/15.jpg"></span>--}}
{{--                            <div>--}}
...
{{--                    <img src="{{url('assets/admin')}}/images/flags/us_flag.jpg" alt="img" class="ml-2 align-self-center">--}}
{{--                    <div>--}}
...
{{--                        <img src="{{url('assets/admin')}}/images/flags/french_flag.jpg" alt="flag-img" class="avatar  ml-3 align-self-center">--}}
{{--                        <div>--}}
{{--                            <strong>French</strong>--}}
{{--                        </div>--}}
{{--                    </a>--}}
{{--                    <a href="#" class="dropdown-item d-flex pb-3">--}}
{{--                        <img src="{{url('assets/admin')}}/images/flags/germany_flag.jpg" alt="flag-img" class="avatar  ml-3 align-self-center">--}}
{{--                        <div>--}}
{{--                            <strong>Germany</strong>--}}
{{--                        </div>--}}
{{--                    </a>--}}
{{--                    <a href="#" class="dropdown-item d-flex pb-3">--}}
{{--                        <img src="{{url('assets/admin')}}/images/flags/italy_flag.jpg" alt="flag-img" class="avatar  ml-3 align-self-center">--}}
{{--                        <div>--}}
{{--                            <strong>Italy</strong>--}}
{{--                        </div>--}}
{{--                    </a>--}}
{{--                    <a href="#" class="dropdown-item d-flex pb-3">--}}
{{--                        <img src="{{url('assets/admin')}}/images/flags/russia_flag.jpg" alt="flag-img" class="avatar  ml-3 align-self-center">--}}
{{--                        <div>--}}
{{--                            <strong>Russia</strong>--}}
{{--                        </div>--}}
{{--                    </a>--}}
{{--                    <a href="#" class="dropdown-item d-flex pb-3">--}}
{{--                        <img src="{{url('assets/admin')}}/images/flags/spain_flag.jpg" alt="flag-img" class="avatar  ml-3 align-self-center">--}}
{{--                        <div>--}}
{{--                            <strong>Spain</strong>--}}
{{--                        </div>--}}
{{--                    </a>--}}
