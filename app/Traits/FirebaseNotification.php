...
Trait  FirebaseNotification
{
    ...
    public function sendBasicNotification($title,$body,$order_id, $user_id=null,$provider_id = null,$type = null,$representative_id = null)
    {
...
//        return $query;
        $tokens = PhoneTokens::where($query)->pluck('token')->toArray();
